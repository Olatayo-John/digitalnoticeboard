...
var projectName = "MoodSwings Admin"
    // Remove Loader
    ...
    if (localStorage.length === 0) {
        ...
        if (getcorkThemeObject !== null) {
            ...
            if (ParsedObject.admin === projectName) {
    ...
    if (corkThemeObject.settings.layout.darkMode) {
        ...
        if (getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', baseURL+'src/assets/img/logo.svg')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
        ...
        if (!getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', baseURL+'assets/img/logo2.svg')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
