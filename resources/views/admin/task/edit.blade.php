                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="project_id" id="project_id" class="form-control project_id">
                                                                <option value="">Select</option>
                                                                @foreach ($projectList as $pList)
                                                                    <option value="{{ $pList->id }}"
                                                                        {{ old('project_id', $task->project_id) == $pList->id ? 'selected' : '' }}>
                                                                        {{ $pList->name }}</option>
                                                                @endforeach
                                                            </select>
                                                            ...
                                                            <select name="assigned_to" id="assigned_to"
                                                                ...
                                                                @foreach ($userList as $uList)
                                                                    <option value="{{ $uList->id }}"
                                                                        {{ old('assigned_to', $task->assigned_to) == $uList->id ? 'selected' : '' }}>
                                                                        {{ $uList->name }}</option>
                                                                @endforeach
                                                            </select>
                                                                ...
                                                                <select name="status" id="" class="form-control">
                                                                    ...
                                                                    @foreach (config('site.project_status') as $pstatus)
                                                                        <option value="{{ $pstatus['value'] }}"
                                                                            {{ old('status', $task->status) == $pstatus['value'] ? 'selected' : '' }}>
                                                                            {{ $pstatus['name'] }}</option>
                                                                    @endforeach
                                                                </select>
                                                                ...
                                                                <select name="priority" id="" class="form-control">
                                                                    ...
                                                                    @foreach (config('site.priority') as $ppriority)
                                                                        <option value="{{ $ppriority['value'] }}"
                                                                            {{ old('priority', $task->priority) == $ppriority['value'] ? 'selected' : '' }}>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="datetime-local" name="start_date_time"
                                                                class="form-control"
                                                                value="{{ old('start_date_time', $task->start_date_time) }}">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="datetime-local" name="end_date_time"
                                                                class="form-control"
                                                                value="{{ old('end_date_time', $task->end_date_time) }}">
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input_" type="radio"
                                                                    name="billable" id="flexRadioDefault1" value="1"
                                                                    {{ $task->billable === '1' ? 'checked' : '' }}>
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input_" type="radio"
                                                                    ...
                                                                    value="0"{{ $task->billable === '0' ? 'checked' : '' }}>
                                            ...
                                            <div class="card p-3">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="description" id="objectiveEditor" class="form-control">{{ old('description', $task->description) }}</textarea>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="notes" id="notesEditor" class="form-control">{{ old('notes', $task->notes) }}</textarea>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="remarks" id="remarksEditor" class="form-control">{{ old('remarks', $task->remarks) }}</textarea>
