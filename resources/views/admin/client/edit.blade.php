                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                    <form action="{{ route('client.update', $client->id) }}" method="post"
                                        enctype="multipart/form-data" id="createClientForm">
                                        @csrf
                                        @method('put')
                                                        ...
                                                        <div class="form-group col-md-5 mb-3">
                                                            <div class="form-group">
                                                                ...
                                                                @if ($client->profile_image)
                                                                    <a href="{{ Storage::url($client->profile_image) }}"
                                                                        target="_blank">
                                                            ...
                                                            <select name="company_country"
                                                                ...
                                                                @foreach ($countryList as $key => $value)
                                                                    <option value="{{ $value['countryName'] }}"
                                                                        ...
                                                                        {{ old('company_country', $client->company_country) == $value['countryName'] ? 'selected' : '' }}>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-4 mb-3">
                                                            ...
                                                            <input type="date" name="business_since"
                                                                class="form-control"
                                                                value="{{ old('business_since', $client->business_since) }}">
            ...
            if (geoNameId) {
                $.ajax({
                    ...
                    success: function(res) {
                        const stateList = res;
                        var state = "{{ old('company_state', $client->company_state) }}";
