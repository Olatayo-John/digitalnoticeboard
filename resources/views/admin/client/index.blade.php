            ...
            <div class="middle-content container-xxl p-0">
                ...
                <div class="page-meta">
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <a href="{{ route('client.create') }}"><button
                ...
                <div class="row layout-top-spacing_">
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing_">
                        <div class="widget-content widget-content-area br-8">
                            <table id="clientTypeTable" class="table table-striped dt-table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <tr>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="usr-img-frame me-2 rounded-circle">
                                                        <img alt="avatar" class="img-fluid rounded-circle"
                                                            src="{{ $client->profile_image ? asset('storage/' . $client->profile_image) : asset('storage/default/no_image.jpg') }}">
                                                    </div>
                                                    <div>
                                                        <div>
                                            ...
                                            <td>
                                                @foreach (config('site.status') as $key => $value)
                                                    @if ($client->is_active === $value['value'])
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <form method="post"
                                                        ...
                                                        @csrf @method('delete')
                                                        <button class="btn- InFormDeleteBtn" formClass="deleteClientForm">
                                                            <svg xmlns="http://www.w3.org/2000/svg" height="1em"
                                                                viewBox="0 0 448 512">
                                                                <path
