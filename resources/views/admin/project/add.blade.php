                                                            ...
                                                            <select class="members form-control" name="members[]"
                                                                ...
                                                                @foreach ($userList as $key => $value)
                                                                    <option value="{{ $value->id }}"
                                                                        {{ old('members') && in_array($value->id, old('members')) ? 'selected' : '' }}>
                                                                        {{ $value->name }}</option>
                                                                @endforeach
                                                            </select>
                                            ...
                                            <div class="card p-3">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="objective" id="objectiveEditor" class="form-control">{{ old('objective') }}</textarea>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="credentials" id="credentialsEditor" class="form-control">{{ old('credentials') }}</textarea>
